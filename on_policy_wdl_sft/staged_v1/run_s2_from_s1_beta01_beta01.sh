...
export RUN_PREFIX=${RUN_PREFIX:-"WDL-SFT-STAGED-V1-S2-FROM-S1-BETA01-BETA01"}
export WDL_SFT_BETA=${WDL_SFT_BETA:-0.1}
export STAGE1_CKPT_DIR=${STAGE1_CKPT_DIR:-"/data-1/checkpoints/ONPOLICY-SFT-Qwen3-4B-MATH-S1-BETA01-V1_1779981295"}
export STAGE1_STEP=${STAGE1_STEP:-150}
