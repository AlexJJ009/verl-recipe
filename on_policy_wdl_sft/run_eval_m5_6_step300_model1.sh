...
#
# Prerequisite: merged joint weights at /data-1/eval_results/wdl-sft-m5_6-step300_merged_joint/
# (produced by run_eval_m5_6_step300.sh Step 1)
set -xeuo pipefail

MERGED_JOINT_PATH=/data-1/eval_results/wdl-sft-m5_6-step300_merged_joint
MODEL1_PATH=/data-1/eval_results/wdl-sft-m5_6-step300_model1
OUTPUT_DIR=/data-1/eval_results/wdl-sft-m5_6-step300_model1_n3_sysprompt
