#!/usr/bin/env bash
# KodCode Instruct-2507 CTX8K P40 Stage2, beta=0.0 Stage1 -> beta=0.0 Stage2.
set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

export RUN_PREFIX=${RUN_PREFIX:-CODE-S2-KODCODE-INSTRUCT2507-CTX8K-P40-BETA0-BETA0-V1}
export STAGE1_RUN_PREFIX=${STAGE1_RUN_PREFIX:-ONPOLICY-SFT-Qwen3-4B-INSTRUCT2507-CODE-KODCODE-CTX8K-S1-BETA0-V1}
export EXPECTED_STAGE1_RUN_PREFIX=${EXPECTED_STAGE1_RUN_PREFIX:-ONPOLICY-SFT-Qwen3-4B-INSTRUCT2507-CODE-KODCODE-CTX8K-S1-BETA0-V1}
...
export EXPECTED_STAGE1_BETA=${EXPECTED_STAGE1_BETA:-0.0}
...
export CODE_TRAIN_FILE=${CODE_TRAIN_FILE:-/data-1/dataset/code/verl_rl/kodcode_stage2_after_s1_seed20260604_beta0_p40_handoff.parquet}
export TRAIN_FILE=${TRAIN_FILE:-$CODE_TRAIN_FILE}
export MODEL2_LABEL=${MODEL2_LABEL:-kodcode_i2507_ctx8k_beta0_p40}
export MODEL2_CACHE_TAG=${MODEL2_CACHE_TAG:-kod_i2507_p40_b0_s2}
export STAGE1_MERGED_MODEL_ROOT=${STAGE1_MERGED_MODEL_ROOT:-/data-1/model_weights/code_task/kodcode_instruct2507_ctx8k_stage2_p40/beta0}
