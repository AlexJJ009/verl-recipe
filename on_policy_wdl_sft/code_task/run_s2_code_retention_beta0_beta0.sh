#!/usr/bin/env bash
# Formal short Stage2 code-task handoff, beta=0.0 Stage1 -> beta=0.0 Stage2.
set -euo pipefail

export RUN_PREFIX=${RUN_PREFIX:-CODE-S2-RETENTION-BETA0-BETA0}
export STAGE1_RUN_PREFIX=${STAGE1_RUN_PREFIX:-ONPOLICY-SFT-Qwen3-4B-CODE-KODCODE-S1-BETA0-V2-RETENTION-R2}
...
export CODE_TRAIN_FILE=${CODE_TRAIN_FILE:-/data-1/dataset/code/verl_rl/kodcode_stage2_after_s1_seed20260604_beta0_p70_handoff.parquet}
export MODEL2_LABEL=${MODEL2_LABEL:-beta0}
