...
export REWARD_TIMEOUT=${REWARD_TIMEOUT:-$CODE_REWARD_MANAGER_TIMEOUT}
if [ "$REWARD_TIMEOUT" != "$CODE_REWARD_MANAGER_TIMEOUT" ]; then
    echo "[code-s1] ERROR: REWARD_TIMEOUT must equal CODE_REWARD_MANAGER_TIMEOUT" >&2
    exit 1
fi
