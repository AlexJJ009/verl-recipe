...
main() {
    ...
    log "code offline eval queue start: benchmark=${BENCHMARK} n=${N_SAMPLES} official_parallel=${CODE_OFFICIAL_EVAL_PARALLEL} START_INDEX=${START_INDEX} END_INDEX=${END_INDEX}"
    for i in "${!LABELS[@]}"; do
