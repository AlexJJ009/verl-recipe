#!/usr/bin/env bash
# KodCode Instruct-2507 CTX8K P60 Stage2, beta=0.0 Stage1 -> beta=0.0 Stage2.
set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

export RUN_PREFIX=${RUN_PREFIX:-CODE-S2-KODCODE-INSTRUCT2507-CTX8K-P60-BETA0-BETA0-V1}
...
export MODEL2_CACHE_TAG=${MODEL2_CACHE_TAG:-kod_i2507_p60_b0_s2}
export STAGE1_MERGED_MODEL_ROOT=${STAGE1_MERGED_MODEL_ROOT:-/data-1/model_weights/code_task/kodcode_instruct2507_ctx8k_stage2_p60/beta0}
