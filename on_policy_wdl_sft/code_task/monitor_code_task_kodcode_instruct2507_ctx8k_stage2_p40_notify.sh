#!/usr/bin/env bash
# Monitor for the KodCode Instruct-2507 CTX8K P40 matched-beta Stage2 queue.
set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

export QUEUE_MODE=kodcode_instruct2507_ctx8k_stage2_p40
export MONITOR_NAME=${MONITOR_NAME:-code_task_kodcode_instruct2507_ctx8k_stage2_p40}
