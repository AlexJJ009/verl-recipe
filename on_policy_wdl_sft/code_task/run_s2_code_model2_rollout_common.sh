...
export CODE_REWARD_MANAGER_TIMEOUT=${CODE_REWARD_MANAGER_TIMEOUT:-$CODE_REWARD_TIMEOUT}
export CODE_REWARD_NUM_WORKERS=${CODE_REWARD_NUM_WORKERS:-4}
export CODE_REWARD_MAX_CONCURRENCY_PER_WORKER=${CODE_REWARD_MAX_CONCURRENCY_PER_WORKER:-16}
...
CODE_REWARD_MANAGER_TIMEOUT=$CODE_REWARD_MANAGER_TIMEOUT
CODE_REWARD_NUM_WORKERS=$CODE_REWARD_NUM_WORKERS
CODE_REWARD_MAX_CONCURRENCY_PER_WORKER=$CODE_REWARD_MAX_CONCURRENCY_PER_WORKER
LCB_INPUT_OUTPUT_INDEX=${LCB_INPUT_OUTPUT_INDEX:-unset}
LCB_INPUT_OUTPUT_INDEX_SHA256=${LCB_INPUT_OUTPUT_INDEX_SHA256:-unset}
LCB_SUBPROCESS_TIMEOUT=${LCB_SUBPROCESS_TIMEOUT:-unset}
