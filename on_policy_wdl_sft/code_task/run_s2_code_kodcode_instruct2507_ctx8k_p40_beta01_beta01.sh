#!/usr/bin/env bash
# KodCode Instruct-2507 CTX8K P40 Stage2, beta=0.1 Stage1 -> beta=0.1 Stage2.
set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

export RUN_PREFIX=${RUN_PREFIX:-CODE-S2-KODCODE-INSTRUCT2507-CTX8K-P40-BETA01-BETA01-V1}
...
export MODEL2_LABEL=${MODEL2_LABEL:-kodcode_i2507_ctx8k_beta01_p40}
export MODEL2_CACHE_TAG=${MODEL2_CACHE_TAG:-kod_i2507_p40_b01_s2}
