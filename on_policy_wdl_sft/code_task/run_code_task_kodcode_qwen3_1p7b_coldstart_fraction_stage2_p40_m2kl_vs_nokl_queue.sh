...
export STAGE2_FRAC25_BETA01_STAGE1_PREFIX=${STAGE2_FRAC25_BETA01_STAGE1_PREFIX:-ONPOLICY-SFT-Qwen3-1P7B-COLDSTART-FRAC25-CODE-KODCODE-CTX8K-S1-BETA01-V1}
export STAGE2_FRAC50_BETA01_STAGE1_PREFIX=${STAGE2_FRAC50_BETA01_STAGE1_PREFIX:-ONPOLICY-SFT-Qwen3-1P7B-COLDSTART-FRAC50-CODE-KODCODE-CTX8K-S1-BETA01-V1}
...
export MODEL2_ROOT=${MODEL2_ROOT:-/data-1/model_weights/code_task/kodcode_qwen3_1p7b_coldstart_fraction_ctx8k_stage2_p40}
