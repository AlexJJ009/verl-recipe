#!/usr/bin/env bash
# Monitor for the KodCode Qwen3-1.7B chat/instruct CTX8K Stage1 queue.
set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

export QUEUE_MODE=kodcode_qwen3_1p7b_instruct_ctx8k_stage1
export MONITOR_NAME=${MONITOR_NAME:-code_task_kodcode_qwen3_1p7b_instruct_ctx8k_stage1}
