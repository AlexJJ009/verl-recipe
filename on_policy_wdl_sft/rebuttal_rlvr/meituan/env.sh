...
if [ "$PLATFORM_MODE" = "1" ]; then
    # A formal worker receives only ROOT plus manifest-bound input artifacts.
    # Do not preserve arbitrary values inherited from the Hope client/image.
    export OUTPUT_ROOT="$ROOT/verl-exp"
    export MODEL_ROOT="$ROOT/models/rebuttal_rlvr/init"
    ...
    export TRAIN_FILE="$ROOT/data/math/train_rl_format.parquet"
    export MATH7_AIME_FILE="$ROOT/data/math7/AIME-2025/aime-2025_with_system_prompt.parquet"
    export MATH7_MATH500_FILE="$ROOT/data/math7/MATH-500/math500-test_with_system_prompt.parquet"
    export MATH7_AMC23_FILE="$ROOT/data/math7/AMC23/amc23-test_with_system_prompt.parquet"
    export MATH7_AQUA_FILE="$ROOT/data/math7/AQUA/aqua-test_with_system_prompt.parquet"
    export MATH7_GSM8K_FILE="$ROOT/data/math7/gsm8k/gsm8k-test_with_system_prompt.parquet"
    export MATH7_MAWPS_FILE="$ROOT/data/math7/MAWPS/mawps-test_with_system_prompt.parquet"
    export MATH7_SVAMP_FILE="$ROOT/data/math7/SVAMP/svamp-test_with_system_prompt.parquet"
else
    ...
    export TRAIN_FILE=${TRAIN_FILE:-"$ROOT/data/math/train_rl_format.parquet"}
    export MATH7_AIME_FILE=${MATH7_AIME_FILE:-"$ROOT/data/math7/AIME-2025/aime-2025_with_system_prompt.parquet"}
    export MATH7_MATH500_FILE=${MATH7_MATH500_FILE:-"$ROOT/data/math7/MATH-500/math500-test_with_system_prompt.parquet"}
    export MATH7_AMC23_FILE=${MATH7_AMC23_FILE:-"$ROOT/data/math7/AMC23/amc23-test_with_system_prompt.parquet"}
    export MATH7_AQUA_FILE=${MATH7_AQUA_FILE:-"$ROOT/data/math7/AQUA/aqua-test_with_system_prompt.parquet"}
    export MATH7_GSM8K_FILE=${MATH7_GSM8K_FILE:-"$ROOT/data/math7/gsm8k/gsm8k-test_with_system_prompt.parquet"}
    export MATH7_MAWPS_FILE=${MATH7_MAWPS_FILE:-"$ROOT/data/math7/MAWPS/mawps-test_with_system_prompt.parquet"}
    export MATH7_SVAMP_FILE=${MATH7_SVAMP_FILE:-"$ROOT/data/math7/SVAMP/svamp-test_with_system_prompt.parquet"}
fi
