#!/usr/bin/env bash
# Offline eval: WDL-SFT 1C (EXP-18) step 300 — model1 (weak/anchor, index=0)
# n=3, 7 benchmarks with system prompt
#
# Prerequisite: merged joint weights at /data-1/model_weights/WDL-SFT-4B-MATH-1C/step_300/
set -xeuo pipefail

MERGED_JOINT_PATH=/data-1/model_weights/WDL-SFT-4B-MATH-1C/step_300
MODEL1_PATH=/data-1/model_weights/WDL-SFT-4B-MATH-1C/step_300_model1
OUTPUT_DIR=/data-1/model_weights/WDL-SFT-4B-MATH-1C/step_300_model1/inference_n3
