#!/usr/bin/env bash
# ==============================================================================
# Ablation 2H-MATH-SFT: single-model wdl_group_adv_is on Hendrycks MATH train,
# initialized from Qwen3-4B-Base-SFT-stage-1.
#
# Purpose: pair with GRPO 2G-MATH-SFT and the 1D joint run to separate loss,
# initialization, and joint-model effects.
# ==============================================================================
set -xeuo pipefail
...
export RUN_PREFIX=${RUN_PREFIX:-"WDL-GROUP-ADV-IS-Qwen3-4B-MATH-2H-MATHDATA-SFT-E1"}
