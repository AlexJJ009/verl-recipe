#!/usr/bin/env bash
# ==============================================================================
# Ablation 2G-MATH-BASE: standard GRPO baseline on Hendrycks MATH train,
# initialized from Qwen3-4B-Base.
#
# This keeps the same GRPO knobs as 2G-BASE, but replaces the EnsembleLLM train
...
export RUN_PREFIX=${RUN_PREFIX:-"GRPO-Qwen3-4B-MATH-2G-MATHDATA-BASE-E1"}
