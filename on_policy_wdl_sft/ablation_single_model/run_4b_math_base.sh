#!/usr/bin/env bash
# ==============================================================================
# 4B-MATH-BASE: single-model current group-advantage IS algorithm on MATH train,
...
export RUN_PREFIX=${RUN_PREFIX:-"WDL-GROUP-ADV-IS-Qwen3-4B-MATH-4B-MATHDATA-BASE-E1"}
