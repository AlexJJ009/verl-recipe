#!/usr/bin/env bash
# ==============================================================================
# Ablation 2H-MATH-BASE: single-model wdl_group_adv_is on Hendrycks MATH train,
# initialized from Qwen3-4B-Base.
#
# Purpose: isolate whether the new group-advantage IS loss helps without the
# joint-model / fused-logit scaffold used by 1D.
# ==============================================================================
set -xeuo pipefail
...
export RUN_PREFIX=${RUN_PREFIX:-"WDL-GROUP-ADV-IS-Qwen3-4B-MATH-2H-MATHDATA-BASE-E1"}
export INIT_MODEL_PATH=${INIT_MODEL_PATH:-"${DATA_ROOT}/.cache/huggingface/models--Qwen--Qwen3-4B-Base/snapshots/906bfd4b4dc7f14ee4320094d8b41684abff8539"}
...
# Match the 1D group-advantage recipe. The common single-model launcher also
# sets rollout_is=null for this loss mode because the loss owns its detached IS.
