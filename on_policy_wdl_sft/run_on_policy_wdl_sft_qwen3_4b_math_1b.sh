#!/usr/bin/env bash
# ==============================================================================
# Post-fix Experiment 1B: joint WDL-SFT-IS, beta=0.1, lr=5e-7.
#
# This is the spec-correct rerun after the 2026-04-27 reward-label handoff fix.
# It writes a LABELFIX-prefixed run and will not resume old pre-fix 1B outputs.
# ==============================================================================
set -xeuo pipefail

export RUN_PREFIX=${RUN_PREFIX:-"WDL-SFT-Qwen3-4B-MATH-1B-LABELFIX"}
